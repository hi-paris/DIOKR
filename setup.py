...
pyx_paths = glob("./stpredictions/**/*.pyx")
...
if os.environ.get('STPREDICTIONS_DISABLE_CYTHONIZE') is None:
    try:
        import Cython
        HAVE_CYTHON = True
    except ImportError:
...
setup(
    author="Structured-Predictions team",
    ...
    entry_points={
        'console_scripts': [
            'stpredictions=stpredictions.cli:main',
        ],
    },
